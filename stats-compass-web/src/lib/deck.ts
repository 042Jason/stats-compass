  ...
  return [
    {
      ...
      title: "생애나침반",
      lead: "조사 이름을 몰라도 통계를 찾습니다. 사람의 질문을 온톨로지 그래프 위에서 풀어, 참고할 국가승인통계와 통계표를 근거와 함께 돌려주는 GraphRAG 검색입니다.",
      stats: [
        { value: nf(c.surveys), label: "국가승인통계 조사" },
...

    {
      ...
      lead: "국가승인통계를 찾으려면 조사 이름을 먼저 알아야 합니다. 그런데 이름을 모르니까 찾는 것입니다.",
      versus: {
        leftTitle: "사람이 묻는 말",
        left: [
          "집을 사려면 빚을 얼마나 져야 하나",
...

    {
      ...
      lead: "질문과 통계표를 직접 비교하지 않습니다. 질문에 가까운 <개념·지표·연구질문>을 먼저 찾고, 거기서 관계를 타고 조사와 통계표에 도달합니다.",
      bullets: [
        "\"빚\" → 용어 <가계부채> → 그 용어를 정의하는 조사 → 그 조사의 통계표",
        "도달한 경로를 그대로 화면에 보여 줍니다. 왜 이 조사가 나왔는지 사용자가 검증할 수 있습니다",
...

    {
      ...
      flow: [
        ...
        { step: "그래프 확장", detail: "찾아낸 씨앗 노드에서 1~2홉을 걸어 조사에 도달합니다. 한 조사가 목록을 독식하지 않게 조사별 대표표를 먼저 채웁니다" },
        { step: "결과", detail: "참고할 조사, 섞어 쓰면 안 되는 조합, 그리고 바로 열 수 있는 통계표ID" },
      ],
...

    {
      ...
      lead: "둘 다 조사 이름이 한 글자도 들어 있지 않습니다. 그런데 가계금융복지조사·주택소유통계·연금통계가 근거 경로와 함께 나옵니다.",
      note: "시나리오는 회귀 검사로 고정해 두었습니다. 기대 조사·기대 통계표뿐 아니라 <나오면 안 되는 조사>도 함께 검사합니다 — 적중률만 높고 결과는 나쁜 상태를 잡기 위해서입니다.",
    },
