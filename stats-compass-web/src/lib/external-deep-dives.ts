...
export const EXTERNAL_DEEP_DIVES: ExternalDeepDive[] = [
  {
    ...
    summary:
      "KOSIS 공식 통계표 136개를 7대 생애주기 타임라인 하나로 묶은 대시보드입니다. 단계마다 핵심 지표와 원천조사를 붙여 두어, 지금 보고 있는 숫자가 어느 조사에서 나온 것인지 바로 확인할 수 있습니다. 초혼연령·주거비 부담·육아휴직 급여 같은 정책 레버 21개를 움직이면 2040년까지의 곡선이 그 자리에서 다시 그려지고, '청년 실업률은 내려갔는데 왜 체감은 그대로인가' 같은 오해도 단계별로 짚어 줍니다.",
