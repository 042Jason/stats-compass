...
export const metadata: Metadata = {
  title: "관계망",
  description:
    "국가승인통계와 통계개념·작성기관·주제분야를 온톨로지로 연결해 탐색합니다. DCAT·SKOS·SDMX 어휘에 매핑했습니다.",
};
  ...
  return (
    <>
      <PageHeader
        eyebrow="온톨로지"
        title="통계 관계망"
        description="통계를 낱개로 보지 않고, 어떤 개념을 공유하는지·어떤 통계와 헷갈리는지·누가 만드는지를 이어서 봅니다. 클래스와 관계는 DCAT 3·SKOS·RDF Data Cube(SDMX) 어휘에 매핑해 두었습니다."
      />
